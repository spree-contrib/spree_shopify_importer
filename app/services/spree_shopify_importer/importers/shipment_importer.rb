  ...
  module Importers
    class ShipmentImporter < BaseImporter
      ...
      def create_data_feed
        SpreeShopifyImporter::DataFeeds::Create.new(@fulfillment, @parent_feed).save!
      end

      def update_data_feed(old_data_feed)
        SpreeShopifyImporter::DataFeeds::Update.new(old_data_feed, @fulfillment, @parent_feed).update!
      end
